...
import com.trovaparco.adapter.ParkAdapter
...
class FavoriteParksFragment : Fragment() {
    ...
    private lateinit var adapter: ParkAdapter  // ✅ DICHIARAZIONE
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = ParkAdapter(emptyList(), onParkClick = { park ->
            // Azione quando si clicca su un parco nei preferiti
